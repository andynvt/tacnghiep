                        ...
                        <div class="table-responsive">
                            <form action="" method="post">
                                <table class="table table-hover" id="filter_tbl">
                                    ...
                                    <tbody>
                                    <?php echo $empLoader->displayAll($getStudent)?>
                                    </tbody>
                                </table>
                            </form>
                        </div>
...
foreach ($getStudent as $st) {
    ?>
    <div class="modal fade" id='stu_<?= $st["student_id"] ?>' tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<?= $st['student_id']; ?>"
                                   readonly="readonly">
                        </div>
                        <div class="form-group">
                            <label for="exampleInput2" class="bmd-label-floating">Tên học sinh</label>
                            <input class="form-control" type="text" value="<?= $st['student_name']; ?>"
                                   readonly="readonly">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="<?= $st['father_name']; ?>"
                                           readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput1" class="bmd-label-floating">Nghề của cha</label>
                                    <input class="form-control" type="text" value="<?= $st['father_job']; ?>"
                                           readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput1" class="bmd-label-floating">Số điện thoại cha</label>
                                    <input class="form-control" type="number" value="<?= $st['father_phone']; ?>"
                                           readonly="readonly">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="<?= $st['mother_name']; ?>"
                                           readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput1" class="bmd-label-floating">Nghề của mẹ</label>
                                    <input class="form-control" type="text" value="<?= $st['mother_job']; ?>"
                                           readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput1" class="bmd-label-floating">Số điện thoại mẹ</label>
                                    <input class="form-control" type="number" value="<?= $st['mother_phone']; ?>"
                                           readonly="readonly">
                                </div>
                            </div>
                        </div>
