                            ...
                            <form style=" width: 45%; float: right;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="hometown"
                                           value="<?php echo $user['hometown']; ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="currAddress"
                                           value="<?php echo $user['current_address']; ?>" readonly>
                            ...
                            <form style="width: 100%; float:left; padding-left: 15%;">
                                <div class="form-group row">
                                    <div class="offset-xs-0 offset-sm-3 col-12 col-sm-9 mt-3">
                                        <input id="btnupdate" name="" data-action="open" type="button"
                                               class="btn btn-primary" data-toggle="modal" data-target="#changePersonal"
                                               value="Cập Nhật">
                                        <input id="close" data-action="open" type="button" class="btn btn-primary"
                                               value="Thoát">
                                    </div>
            ...
            <div class="modal-body">
                <form method="post" id="personal">
                    ...
                    <div class="modal-footer">
                        ...
                        <span></span>
                        <button type="submit" class="btn btn-primary" id="update" name="update-student">CẬP NHẬT
                        </button>
                    </div>
