    ...
    <body class="">
        <div class="wrapper">
                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="../kiem-toan/cash.html">
                            <i class="material-icons">attach_money</i>
                            <p>Quản lí tài chính</p>
                        </a>
                        </li>
                        <li class="nav-item active-pro ">
                            <a class="nav-link" href="../kiem-toan/index.html">
            ...
            <div class="main-panel">
                ...
                <div class="modal fade" id="addInAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="detailInAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="editInAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">ĐÓNG</button>
                                        <span></span>
                                        <button type="submit" id="btn-update" class="btn btn-primary" name="edit-in-audit">LƯU LẠI</button>
                                        <?php
                ...
                <div class="modal fade" id="deleteInAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                  ...
                  <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-footer">
                                <form method="post">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">ĐÓNG</button>
                                    <span></span>
                                    <button type="submit" id="btn-delete" class="btn btn-primary" name="delete-in-audit">CHẤP NHẬN</button>
                                    <?php
                ...
                <div class="modal fade" id="addOutAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="detailOutAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="editOutAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Sửa thông tin</h5>
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">ĐÓNG</button>
                                        <span></span>
                                        <button type="submit" id="btn-update" class="btn btn-primary" name="edit-out-audit">LƯU LẠI</button>
                                         <?php
                ...
                <div class="modal fade" id="deleteOutAuditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Xác nhận xóa</h5>
                  ...
                  <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-footer">
                                <form method="post">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">ĐÓNG</button>
                                    <span></span>
                                    <button type="submit" id="btn-delete" class="btn btn-primary" name="delete-out-audit">CHẤP NHẬN</button>
                                    <?php
                ...
                <div class="content">
                    <div class="container-fluid">
                        <button type="button" class="btn btn-secondary btn-lg" role="button" aria-disabled="true" data-toggle="modal" data-target="#addInAuditModal">
              ...
              Thêm phí thu mới
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td class="td-actions text-center">
                                                        <button type="button" rel="tooltip" class="btn btn-info" data-toggle="modal" data-target="#detailInAuditModal">
                                <i class="material-icons">remove_red_eye</i>
                              </button>
                                                        <button type="button" value="<?= $value["ia_id"] ?>" rel="tooltip" class="btn btn-success" data-toggle="modal" data-target="#editInAuditModal">
                                <i class="material-icons">edit</i>
                              </button>
                                                        <button type="button" value="<?= $value["ia_id"] ?>" rel="tooltip" class="btn btn-danger" data-toggle="modal" data-target="#deleteInAuditModal">
                    ...
                    <div class="container-fluid">
                        <button type="button" class="btn btn-secondary btn-lg" role="button" aria-disabled="true" data-toggle="modal" data-target="#addOutAuditModal">
              <i class="material-icons">add_circle_outline</i>
              Thêm phí chi mới
            </button>
                        <div class="row">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($outAudit_array as $value) {
                                                             ...
                                                             ?>
                                                    <td class="td-actions text-center">
                                                        <button type="button" rel="tooltip" class="btn btn-info" data-toggle="modal" data-target="#detailOutAuditModal">
                                <i class="material-icons">remove_red_eye</i>
                              </button>
                                                        <button type="button" value="<?= $value["oa_id"] ?>" rel="tooltip" class="btn btn-success" data-toggle="modal" data-target="#editOutAuditModal">
                                <i class="material-icons">edit</i>
                              </button>
                                                        <button type="button" value="<?= $value["oa_id"] ?>" rel="tooltip" class="btn btn-danger" data-toggle="modal" data-target="#deleteOutAuditModal">
                                <i class="material-icons">close</i>
                              </button>
                                                    </td>
                                                    <?php
