                            ...
                            <div class="col-12 col-sm-10 offset-sm-1" id="body-form">
                                ...
                                ?>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo $one['emp_name']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Năm Sinh</label>
                                            <input class="form-control" type="text" value="<?php echo $one['dob']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Giới Tính</label>
                                            <input class="form-control" type="text" value="<?php echo $one['gender']; ?>" readonly/>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">CMND</label>
                                            <input class="form-control" type="text" name="idcard" value="<?php echo $one['id_card']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Ngày Vào</label>
                                            <input class="form-control" type="text" name="doi" value="<?php echo $one['doi']; ?>" readonly/>
                                        </div>
                                </form>
                                <form style=" width: 45%; float: right;">
                                    <div class="form-group">
                                        <label class="col-form-label">Quê Quán</label>
                                        <input class="form-control" type="text" name="hometown" value="<?php echo $one['hometown']; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Địa Chỉ</label>
                                        <input class="form-control" type="text" name="address" value="<?php echo $one['address']; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Địa Chỉ Hiện Tại</label>
                                        <input class="form-control" type="text" name="currAddress" value="<?php echo $one['current_address']; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Điện Thoại</label>
                                        <input class="form-control" type="text" name="phone" value="<?php echo $one['phone']; ?>" readonly>
                                    </div>
                                    <?php
                                }
                                }
