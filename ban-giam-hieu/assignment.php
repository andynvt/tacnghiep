                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <span aria-hidden="true">&times;</span>
                          ...
                          <option>2017 - 2018</option>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Học kì</label>
                                        <select class="form-control" id="exampleFormControlSelect1">
                          <option>I</option>
                          <option>II</option>
                        </select>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <option>Mầm 1</option>
                                      <option>Mầm 2</option>
                                      <option>Chồi 1</option>
                                      <option>Chồi 2</option>
                                      <option>Lá 1</option>
                                      <option>Lá 2</option>
                                    </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1">
                                        <option>Nguyễn Hoài Chung</option>
                                        <option>Huỳnh Khắc Duy</option>
                                        <option>Đặng Minh Nhựt</option>
                                        <option>Võ Hoài Phong</option>
                                        <option>Võ Nguyễn Đại Phúc</option>
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="2014-2015" readonly="readonly">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Học kỳ</label>
                                        <input class="form-control" type="text" value="I" readonly="readonly">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="Nguyễn Hoài Chung" readonly="readonly">
                                    </div>
                                    <div class="modal-footer">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td class="td-actions text-center">
                                                        <button type="button" rel="tooltip" class="btn btn-info" data-toggle="modal" data-target="#detailModal"><i class="material-icons">person</i></button>
                                                        <button type="button" rel="tooltip" class="btn btn-success" data-toggle="modal" data-target="#editModal"><i class="material-icons">edit</i></button>
                                                        <button type="button" rel="tooltip" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal"><i class="material-icons">close</i></button>
                                                    </td>
